game.PlayerEntity = me.Entity.extend({
    init: function(x, y, settings) {
        ...
        // enable keyboard
        me.input.bindKey(me.input.KEY.LEFT,  "left", false, true);
        me.input.bindKey(me.input.KEY.RIGHT, "right", false, true);
        me.input.bindKey(me.input.KEY.SPACE, "jump", true, true);
        me.input.bindKey(me.input.KEY.UP,    "jump", true, true);
        me.input.bindKey(me.input.KEY.DOWN,  "down", false, true);

        me.input.bindKey(me.input.KEY.A,     "left", false, true);
        me.input.bindKey(me.input.KEY.D,     "right", false, true);
        me.input.bindKey(me.input.KEY.W,     "jump", true, true);
        me.input.bindKey(me.input.KEY.S,     "down", false, true);
